...
let noScale = 1;
let yesScale = 1;
const gifElement = document.getElementById("css_id");
...
// Edit yay picture (1st one) and sad pictures!
const gifs = ["assets/images/yay_pic.gif", "assets/images/pic.gif", "assets/images/pic.gif", "assets/images/pic.gif"];
